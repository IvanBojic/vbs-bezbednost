...
<html class="no-js" lang="en">
    ...
    <!-- end header -->
                ...
                <div class="row">
                    <div class="col-12 page-title-large d-flex flex-column justify-content-center text-center">
                        ...
                        <h1 class="alt-font text-white-2 font-weight-600 mb-0">
                            Centar za obuku službenika obezbeđenja
                        </h1>
                        <!-- end page title -->
                    </div>
                </div>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-12 margin-60px-bottom sm-margin-30px-bottom wow animate__fadeIn"><img src="images/img/usluga-3-baner.png" alt=""/></div>
                </div>
                <div class="row">
                    <!-- start service item -->
                    <div class="col-12 col-lg-6 col-md-6 col-sm-12 wow animate__fadeInUp">
                        <div class="sm-margin-30px-bottom wow animate__fadeIn margin-30px-left">
                            <p class="w-95 md-w-100 sm-w-95 sm-margin-15px-bottom">
                                U skladu sa Zakonom o privatnom obezbeđenju, naša kompanija vrši stručnu obuku kandidata za službenike obezbeđenja
                                u skladu sa Ovlašćenjem izdatim od strane Ministarstva unutrašnjih poslova i to:
                            </p>
                            <ul class="font-weight-500">
                                <li>O1 - stručnu obuku za obavljanje poslova procene rizika u zaštiti lica, imovine i poslovanja</li>
                                <li>O2 - stručnu obuku za obavljanje poslova fizičko - tehničke zaštite i redarske službe</li>
                                <li>O3 - stručnu obuku za obavljanje poslova planiranja, projektovanja i nadzora nad izvođenjem sistema tehničke zaštite, montaže, puštanja u rad, održavanje sistema tehničke zaštite i obuka korisnika</li>
                            </ul>
                    ...
                    <div class="col-12 col-lg-6 col-md-6 col-sm-12 wow animate__fadeInUp">
                        <div class="sm-margin-30px-bottom wow animate__fadeIn margin-30px-left">
                            <img src="images/img/usluga-3-slika.png" alt=""/>
                        </div>
                    </div>
                    <!-- end service item -->
                </div>
