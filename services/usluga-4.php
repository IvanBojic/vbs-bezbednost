...
<html class="no-js" lang="en">
    ...
    <!-- end header -->
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-12 margin-60px-bottom sm-margin-30px-bottom wow animate__fadeIn"><img src="images/img/usluga-4-baner.jpg" alt=""/></div>
                </div>
                <div class="row justify-content-center">
                    <div class="row">
                        ...
                        <!-- end service item -->
                        <!-- start service item -->
                        <div class="col-12 col-lg-12 col-md-6 col-sm-12 wow animate__fadeInUp margin-50px-top" data-wow-delay="0.2s">
                    ...
                    <div class="row">
                        <!-- start service item -->
                        <div class="col-12 col-lg-12 col-md-6 col-sm-12 wow animate__fadeInUp margin-50px-top" data-wow-delay="0.4s">
