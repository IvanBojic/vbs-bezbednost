            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center margin-100px-bottom md-margin-70px-bottom sm-margin-50px-bottom">
                        ...
                        <h5 class="text-uppercase alt-font text-extra-dark-gray margin-20px-bottom font-weight-700 md-w-100">our services</h5>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center margin-100px-bottom md-margin-70px-bottom sm-margin-50px-bottom">
                        ...
                        <h5 class="text-uppercase alt-font text-extra-dark-gray margin-10px-top margin-20px-bottom font-weight-700 md-w-100 sm-w-100">Latest Blogs</h5>
                        <span class="separator-line-horrizontal-medium-light2 bg-deep-pink d-table mx-auto w-100px"></span>
                    </div>
                </div>
                <div class="row">
                        ...
                        <ul class="blog-classic blog-wrapper grid grid-loading grid-4col xl-grid-4col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large">
                            ...
                            <li class="grid-item last-paragraph-no-margin wow animate__fadeInUp">
                                <div class="blog-post blog-post-style1 text-center text-sm-start">
                                    ...
                                    <div class="post-details margin-20px-bottom xs-no-margin-bottom">
                                        <span class="post-author text-extra-small text-medium-gray text-uppercase d-block margin-10px-bottom sm-margin-5px-bottom">25 April 2017 | by <a href="blog-classic.html" class="text-medium-gray">Jay Benjamin</a></span>
                                        <a href="blog-standard-post.html" class="post-title text-medium text-extra-dark-gray w-90 d-block md-w-100">I like the body. I like to design everything to do with the body.</a>
                            ...
                            <li class="grid-item last-paragraph-no-margin wow animate__fadeInUp" data-wow-delay="0.2s">
                                <div class="blog-post blog-post-style1 text-center text-sm-start">
                                    ...
                                    <div class="post-details margin-20px-bottom xs-no-margin-bottom">
                                        <span class="post-author text-extra-small text-medium-gray text-uppercase d-block margin-10px-bottom sm-margin-5px-bottom">20 April 2017 | by <a href="blog-classic.html" class="text-medium-gray">Herman Miller</a></span>
                            ...
                            <li class="grid-item last-paragraph-no-margin wow animate__fadeInUp" data-wow-delay="0.4s">
                                <div class="blog-post blog-post-style1 text-center text-sm-start">
                                    ...
                                    <div class="post-details margin-20px-bottom xs-no-margin-bottom">
                                        <span class="post-author text-extra-small text-medium-gray text-uppercase d-block margin-10px-bottom sm-margin-5px-bottom">15 march 2017 | by <a href="blog-classic.html" class="text-medium-gray">Hugh Macleod</a></span>
                                        <a href="blog-standard-post.html" class="post-title text-medium text-extra-dark-gray w-90 d-block md-w-100">Recognizing the need is the primary condition for design.</a>
                                        <div class="separator-line-horrizontal-full bg-medium-light-gray margin-20px-tb md-margin-15px-tb"></div>
                                        <p class="w-90 sm-w-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum text...</p>
                                    </div>
                                </div>
                            ...
                            <li class="grid-item last-paragraph-no-margin wow animate__fadeInUp" data-wow-delay="0.6s">
                                <div class="blog-post blog-post-style1 text-center text-sm-start">
                                    ...
                                    <div class="post-details margin-20px-bottom xs-no-margin-bottom">
                                        ...
                                        <a href="blog-post-layout-02.html" class="post-title text-medium text-extra-dark-gray w-90 d-block md-w-100">Get in over your head as often and as joyfully as possible.</a>
                                        <div class="separator-line-horrizontal-full bg-medium-light-gray margin-20px-tb md-margin-15px-tb"></div>
                                        <p class="w-90 sm-w-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum text...</p>
                                    </div>
                                </div>
