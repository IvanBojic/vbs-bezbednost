                        ...
                        <div class="swiper-container text-center black-move wow animate__fadeIn" data-slider-options='{ "slidesPerView": "1", "loop":false, "allowTouchMove":true, "autoplay": { "delay": 3000, "disableOnInteraction": false}, "keyboard": { "enabled": true, "onlyInViewport": true }, "navigation": { "nextEl": ".swiper-button-next-1", "prevEl": ".swiper-button-prev-1" }, "pagination": { "el": ".swiper-pagination-1", "clickable": true }, "breakpoints": { "1200":{ "slidesPerView":"5" }, "992": { "slidesPerView":"4" }, "768": { "slidesPerView":"4" } } }'>
                            <div class="swiper-wrapper">
                                ...
                                <?php foreach ($slike as $slika) { ?>
                                    <div class="swiper-slide"><img src="<?= $slika['path']; ?>" alt=""><span class="text-medium block mt-2 font-weight-300 notranslate"><?= $slika['title']; ?></span></div>
                                <?php }  ?>
                                <!-- end slide -->
                            </div>
                        </div>
    ...
    <?php /*
        ...
        <section class="border-top border-color-extra-light-gray wow animate__fadeIn">
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center margin-100px-bottom md-margin-70px-bottom sm-margin-50px-bottom">
                        <h5 class="text-uppercase alt-font text-extra-dark-gray margin-10px-top margin-20px-bottom font-weight-700 md-w-100 sm-w-100">Novosti</h5>
                        <span class="separator-line-horrizontal-medium-light2 bg-deep-pink d-table mx-auto w-100px"></span>
                    </div>
                </div>
                <div class="row">
                        ...
                        <ul class="blog-classic blog-wrapper grid grid-loading grid-4col xl-grid-4col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large">
                            ...
                            <li class="grid-item last-paragraph-no-margin wow animate__fadeInUp">
                                <div class="blog-post blog-post-style1 text-center text-sm-start feature-box">
                                    ...
                                    <div class="post-details margin-20px-bottom xs-no-margin-bottom">
                                        <a href="news/vest-1.php" class="post-title text-medium text-extra-dark-gray w-90 d-block md-w-100">I like the body. I like to design everything to do with the body.</a>
                            ...
                            <li class="grid-item last-paragraph-no-margin wow animate__fadeInUp" data-wow-delay="0.4s">
                                <div class="blog-post blog-post-style1 text-center text-sm-start feature-box">
                                    ...
                                    <div class="post-details margin-20px-bottom xs-no-margin-bottom">
                                        <a href="news/vest-1.php" class="post-title text-medium text-extra-dark-gray w-90 d-block md-w-100">Recognizing the need is the primary condition for design.</a>
                                        <div class="separator-line-horrizontal-full bg-medium-light-gray margin-20px-tb md-margin-15px-tb"></div>
                                        <p class="w-90 sm-w-100">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum text...</p>
                                    </div>
                                </div>
